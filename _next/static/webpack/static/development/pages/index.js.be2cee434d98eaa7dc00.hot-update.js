...
})(["position:relative;cursor:pointer;width:calc(25% - 24px);@media (max-width:1440px){width:calc(33% - 24px);}@media (max-width:768px){width:calc(50% - 24px);}@media (max-width:768px){width:calc(50% - 24px);}"]);
...
//# sourceMappingURL=index.js.be2cee434d98eaa7dc00.hot-update.js.map